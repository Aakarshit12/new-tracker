// Fix for delivery partner functionality
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Initialize when delivery tab is shown
    document.querySelector('.tab[data-tab="delivery"]').addEventListener('click', function() {
        setTimeout(() => {
            ...
            if (!window.simulatorMap && document.getElementById('simulator-map')) {
                ...
                console.log('Simulator map initialized');
            }
            
            // Add click handlers to delivery orders
            addDeliveryOrderClickHandlers();
        }, 500);
    });
    
    // If delivery tab is already active, initialize map and add click handlers
